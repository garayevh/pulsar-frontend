...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-[220px] min-w-[220px] flex-col border-r border-surface-800 bg-surface-950">
      <div className="border-b border-surface-800 px-5 py-5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[18px] font-medium text-surface-50">Pulsar</span>
        </div>
        <p className="mt-0.5 text-[11px] text-surface-500">AI-Assisted QA Platform</p>
      </div>
